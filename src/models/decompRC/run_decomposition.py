...
BASE_DIR = "/scratch/tabhishek/decomrc"
def main():
    ...
    new_data_path = os.path.join(BASE_DIR, "data", "decomposed", "{}.json")
    new_data1_path = os.path.join(BASE_DIR, "data", "decomposed", "{}.1.json")
    new_data2_path = os.path.join(BASE_DIR, "data", "decomposed", "{}.2.json")

    if not os.path.isdir(os.path.join(BASE_DIR, 'data', 'decomposed-predictions')):
        os.makedirs(os.path.join(BASE_DIR, 'data', 'decomposed-predictions'))
    ...
    if args.task == "decompose":
        ...
        with open(os.path.join(BASE_DIR, 'data', 'hotpot-all', '{}.json'.format(data_type)), 'r') as f:
        ...
        if not os.path.isdir(os.path.join(BASE_DIR, 'data', 'decomposed')):
            os.makedirs(os.path.join(BASE_DIR, 'data', 'decomposed'))
